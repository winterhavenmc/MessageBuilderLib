...
public class DisplayNameResolverTest {
	...
	class PlayerDisplayNameResolverTests {
		...
		public void testGetDisplayName_withValidPlayer() {
			...
			// Act
			DisplayNameable resolver = DisplayNameResolver.asDisplayNameable(playerMock);
			if (resolver != null) {
		...
		public void testGetDisplayName_withNullPlayer() {
			...
			// Act
			DisplayNameable resolver = DisplayNameResolver.asDisplayNameable(nullPlayer);
			if (resolver != null) {
				displayName = resolver.getDisplayName();
			}
		...
		public void testConstructor_withNullPlayer() {
			...
			// Act
			DisplayNameable resolver = DisplayNameResolver.asDisplayNameable(null);
			if (resolver != null) {
				displayName = resolver.getDisplayName();
			}
	...
	class EntityDisplayNameableTests {
		...
		void testGetDisplayName_withValidEntity() {
			...
			// Act
			DisplayNameable resolver = DisplayNameResolver.asDisplayNameable(entityMock);
			if (resolver != null) {
				displayName = resolver.getDisplayName();
			}
	...
	class WorldDisplayNameableTests {
		...
		void testGetDisplayName_withValidWorld() {
			...
			// Act
			DisplayNameable resolver = DisplayNameResolver.asDisplayNameable(worldMock);
			if (resolver != null) {
				displayName = resolver.getDisplayName();
			}
