...
package com.winterhavenmc.library;
...
import static com.winterhavenmc.library.TimeUnit.*;
...
class TimeUnitTest
{
	...
	void overflowTests(final TimeUnit timeUnit) {
		...
		for (TimeUnit innerTimeUnit : TimeUnit.values()) {
	...
	void convert(final TimeUnit timeUnit) {
	...
	@Test
	void values() {
		TimeUnit[] bukkitTimes = { MILLISECONDS, TICKS, SECONDS, MINUTES, HOURS, DAYS, WEEKS, MONTHS, YEARS };
		Assertions.assertArrayEquals(TimeUnit.values(), bukkitTimes, "TimeUnit values did not match.");
	...
	void valueOf() {
		...
		assertEquals(MILLISECONDS, TimeUnit.valueOf("MILLISECONDS"));
		assertEquals(TICKS, TimeUnit.valueOf("TICKS"));
		assertEquals(SECONDS, TimeUnit.valueOf("SECONDS"));
		assertEquals(MINUTES, TimeUnit.valueOf("MINUTES"));
		assertEquals(HOURS, TimeUnit.valueOf("HOURS"));
		assertEquals(DAYS, TimeUnit.valueOf("DAYS"));
		assertEquals(WEEKS, TimeUnit.valueOf("WEEKS"));
