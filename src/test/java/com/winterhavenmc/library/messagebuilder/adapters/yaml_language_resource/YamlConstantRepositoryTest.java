...
class YamlConstantRepositoryTest
{
	...
	void setUp() throws InvalidConfigurationException
	{
		...
		languageSectionProvider = new LanguageSectionProvider(configurationSupplier, Section.CONSTANTS);
		constantRepository = new YamlConstantRepository(languageSectionProvider);
	}
