 ...
 * @see MultiverseCore
 */
public class MultiverseV4WorldNameResolver implements WorldNameResolver
{
	 ...
	 */
	public MultiverseV4WorldNameResolver(MultiverseCore multiverseCore)
	{
	...
	public String resolveWorldName(final World world)
	{
		...
		final String mvAlias = new MultiverseV4WorldNameRetriever(multiverseCore).getWorldName(world);
