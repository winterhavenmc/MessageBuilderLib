 ...
 *     {@link com.winterhavenmc.library.messagebuilder.pipeline.resolvers.itemname.ItemPluralNameResolver ItemPluralNameResolver}</li>
 * </ul>
 *
 * @see PluralNameable
 * @see Adapter
...
public class PluralNameAdapter implements Adapter
{
	 ...
	 */
	public PluralNameAdapter(final AdapterContextContainer ctx)
	{
		this.ctx = ctx;
	}
