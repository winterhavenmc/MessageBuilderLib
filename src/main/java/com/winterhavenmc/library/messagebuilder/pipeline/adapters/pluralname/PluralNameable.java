...
package com.winterhavenmc.library.messagebuilder.pipeline.adapters.pluralname;
...
import static com.winterhavenmc.library.messagebuilder.pipeline.adapters.Adapter.BuiltIn.PLURAL_NAME;
...
public interface PluralNameable
{
	 ...
	 */
	default MacroStringMap extractPluralName(final ValidMacroKey baseKey, final AdapterContextContainer ctx)
	{
