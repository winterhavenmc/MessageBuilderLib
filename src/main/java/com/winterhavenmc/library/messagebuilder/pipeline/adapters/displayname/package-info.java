 ...
 *
 * <p>Any object that implements the {@link com.winterhavenmc.library.messagebuilder.pipeline.adapters.displayname.DisplayNameable DisplayNameable}
 ...
 * <ul>
 *   <li>{@link com.winterhavenmc.library.messagebuilder.pipeline.adapters.displayname.DisplayNameable}
 *   — a functional interface describing
 *   objects that expose a {@code getDisplayName()} method.</li>
 *   <li>{@link com.winterhavenmc.library.messagebuilder.pipeline.adapters.displayname.DisplayNameAdapter} — an
 ...
 *
 * @see com.winterhavenmc.library.messagebuilder.pipeline.adapters.displayname.DisplayNameable
 * @see com.winterhavenmc.library.messagebuilder.pipeline.adapters.displayname.DisplayNameAdapter
 */
