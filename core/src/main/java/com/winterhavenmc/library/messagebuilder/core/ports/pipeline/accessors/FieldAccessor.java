 ...
 * from an object that has been successfully adapted by a given {@link Accessor}.
 * <p>
 ...
 * <p>
 * Each {@code Accessor} is responsible for adapting a specific object type to a known
 * functional interface (e.g., {@code Nameable}, {@code Locatable}, {@code Ownable}, etc.).
 * The {@code FieldAccessor} then calls the appropriate extraction method for that interface,
...
public interface FieldAccessor
{
	 ...
	 * @param accessor the accessor used to produce the adapted object
	 ...
	 */
	<T> MacroStringMap extract(ValidMacroKey baseKey, Accessor accessor, T adapted);
}
