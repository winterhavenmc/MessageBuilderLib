 ...
 * <ul>
 *   <li>{@link com.winterhavenmc.library.messagebuilder.core.maps.MacroObjectMap}
 *       — a type-safe map that holds raw object values keyed by
 *       {@link com.winterhavenmc.library.messagebuilder.models.keys.MacroKey LegacyMacroKey}.
 *       Used during early phases of the message pipeline, especially in adapter chains.</li>
 *   <li>{@link com.winterhavenmc.library.messagebuilder.core.maps.MacroStringMap MacroStringMap}
 ...
 *
 * @see com.winterhavenmc.library.messagebuilder.core.maps.MacroObjectMap
 * @see com.winterhavenmc.library.messagebuilder.core.maps.MacroStringMap
 */
