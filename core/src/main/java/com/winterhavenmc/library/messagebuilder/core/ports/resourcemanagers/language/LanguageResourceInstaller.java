...
import com.winterhavenmc.library.messagebuilder.core.ports.resourcemanagers.ResourceInstaller;
...
import static com.winterhavenmc.library.messagebuilder.core.ports.resourcemanagers.language.LanguageConfigConstant.RESOURCE_AUTO_INSTALL;
...
public final class LanguageResourceInstaller implements ResourceInstaller
{
	 ...
	 */
	public InstallerStatus installIfMissing(final String resourceName)
	{
