...
public final class LocalizedDurationFormatter implements DurationFormatter
{
	 ...
	 */
	public LocalizedDurationFormatter(final DurationFormatter delegate, final ConstantRepository constants)
	{
		validate(delegate, Objects::isNull, throwing(PARAMETER_NULL, DELEGATE));
		validate(constants, Objects::isNull, throwing(PARAMETER_NULL, LANGUAGE_RESOURCE_MANAGER));
	...
	{
		return constants.getString(constantKey).orElseGet(durationType::getFallback);
	}
