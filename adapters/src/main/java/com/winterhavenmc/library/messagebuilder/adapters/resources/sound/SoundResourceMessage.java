...
public enum SoundResourceMessage
{
	...
	SOUND_RESOURCE_EXCEPTION("An exception occurred while attempting to load language file ''{0}''."),
	...
	SOUND_RESOURCE_LOAD_SUCCESS("Language file ''{0}'' successfully loaded."),
	;
