...
public enum LanguageResourceMessage
{
	...
	LANGUAGE_RESOURCE_LOAD_MISSING("The file '{0}' does not exist in the plugin data folder."),
	LANGUAGE_RESOURCE_LOAD_EXCEPTION("An exception occurred while attempting to load language file ''{0}''."),
