...
public class LoggingLocaleSetting implements Supplier<LocaleSetting>
{
	private final Plugin plugin;


	LoggingLocaleSetting(final Plugin plugin)
	{
		this.plugin = plugin;
	}
	...
	{
		return (plugin.getConfig().isString(BukkitConfigRepository.ConfigKey.LOCALE_LOG.key()))
				? new LocaleSetting(LanguageTag.of(plugin.getConfig().getString(BukkitConfigRepository.ConfigKey.LOCALE_LOG.key()))
