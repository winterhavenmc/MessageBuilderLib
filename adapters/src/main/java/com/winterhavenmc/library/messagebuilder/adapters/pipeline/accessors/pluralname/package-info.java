/**
 * Provides an adapter and interface for extracting and formatting plural names from objects. Intended for use with
 * MessageBuilder custom items declared in the language file, but any type that implements the PluralNameable interface
 * will have the plural name field populated in the string result map and available for message placeholder replacement.
 *
