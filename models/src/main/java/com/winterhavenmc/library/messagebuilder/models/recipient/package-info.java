 ...
 * <ul>
 *   <li>{@link com.winterhavenmc.library.messagebuilder.models.recipient.Recipient.Valid} –
 *       A standard, recognized sender such as a player, console, or command block</li>
 *   <li>{@link com.winterhavenmc.library.messagebuilder.models.recipient.Recipient.Proxied} –
 *       A {@link org.bukkit.command.ProxiedCommandSender ProxiedCommandSender} that represents a delegated command flow</li>
 *   <li>{@link com.winterhavenmc.library.messagebuilder.models.recipient.Recipient.Invalid} –
 *       A null or unsupported sender, accompanied by a reason code</li>
 * </ul>
 *
 * <h2>Usage</h2>
 * The factory method {@link com.winterhavenmc.library.messagebuilder.models.recipient.Recipient#of(CommandSender)}
 ...
 *
 * @see com.winterhavenmc.library.messagebuilder.models.recipient.Recipient
 * @see com.winterhavenmc.library.messagebuilder.models.recipient.Recipient.Valid
 * @see com.winterhavenmc.library.messagebuilder.models.recipient.Recipient.Proxied
 * @see com.winterhavenmc.library.messagebuilder.models.recipient.Recipient.Invalid
