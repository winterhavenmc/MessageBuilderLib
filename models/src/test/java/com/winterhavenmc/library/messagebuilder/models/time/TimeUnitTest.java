...
import static com.winterhavenmc.library.messagebuilder.models.time.TimeUnit.*;
...
class TimeUnitTest {
	...
	void values() {
		...
		assertArrayEquals(TimeUnit.values(), bukkitTimes, "TimeUnit values did not match.");
